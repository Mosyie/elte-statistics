...
for (i in 1:nrow(data)) {
  ...
  pie(
    ...
    cex.main = 1,  # Címek méretének csökkentése
    cex = 1  # A címek és az értékek méretének csökkentése
  )
  ...
  barplot(
    ...
    las = 2,
    cex.main = 1,  # Címek méretének csökkentése
    cex.names = 1  # Pártok neveinek betűméretének csökkentése
  )
...
Például, A JOBBIK felső kvartilise 8,35%, tehát azokban a megyékben, ahol a JOBBIK a saját szavazatai közül a legtöbb szavazatot kapta, ott ez volt az alsó határ.
...
. 
Például, Az MKKP alsó kvartilise 1,87%, tehát azokban a megyékben, ahol a MKKP a saját szavazatai közül a legkevesebb szavazatot kapta, ott ez volt a felső határ.
...
Például: A FIDESZ mediánja 54,28%, tehát a megyék felében ennél kisebb szavazati százalékot kaptak, a másik felében meg ennél nagyobb szavazati százalékot kaptak.


**Tapasztalati szórás:** Az átlagtól való átlagos eltérést jelenti százalékban.

Például: A MOMENTUM-ra leadott szavazatok megyékként a MOMENTUM átlagtól átlagosan 2.71 %-al tér el.
...
Például: A MI HAZÁNK-ra leadott szavazatok alapján az összes megyére nézve 95%-os eséllyel egyik megyében sem volt kisebb a szavazati arány a párta, mint 3,23%.
...
Például: Az LMP-re leadott szavazatok alapján az összes megyére nézve 95%-os eséllyel egyik megyében sem volt nagyobb a szavazati arány a párta, mint 2,17%.
